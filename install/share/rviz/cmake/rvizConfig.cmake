...
if("FALSE" STREQUAL "TRUE")
  ...
  set(rviz_INSTALL_PREFIX /home/sudha/catkin_ws/install)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE;/usr/include;/opt/ros/hydro/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudha/catkin_ws/install/${idir}'.  Ask the maintainer 'David Gossow <dgossow@gmail.com>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rviz_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz;default_plugin;/usr/lib/i386-linux-gnu/libOgreMain.so;/usr/lib/i386-linux-gnu/libpthread.so;/usr/lib/i386-linux-gnu/libGLU.so;/usr/lib/i386-linux-gnu/libGL.so;/usr/lib/i386-linux-gnu/libSM.so;/usr/lib/i386-linux-gnu/libICE.so;/usr/lib/i386-linux-gnu/libX11.so;/usr/lib/i386-linux-gnu/libXext.so;/opt/ros/hydro/lib/liburdfdom_sensor.so;/opt/ros/hydro/lib/liburdfdom_model_state.so;/opt/ros/hydro/lib/liburdfdom_model.so;/opt/ros/hydro/lib/liburdfdom_world.so;/opt/ros/hydro/lib/libconsole_bridge.so")
