...
if(NOT "/home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/sbpl_recovery/include" STREQUAL "")
  set(sbpl_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/sbpl_recovery/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'sbpl_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/sbpl_recovery/${idir}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
    endif()
