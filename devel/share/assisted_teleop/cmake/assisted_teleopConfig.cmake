...
if("TRUE" STREQUAL "TRUE")
  set(assisted_teleop_SOURCE_PREFIX /home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/assisted_teleop)
  set(assisted_teleop_DEVEL_PREFIX /home/sudha/catkin_ws/devel)
  ...
  set(assisted_teleop_INSTALL_PREFIX /home/sudha/catkin_ws/install)
...
if(NOT "/home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/assisted_teleop/include;/usr/include/eigen3" STREQUAL "")
  set(assisted_teleop_INCLUDE_DIRS "")
  set(_include_dirs "/home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/assisted_teleop/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'assisted_teleop' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'assisted_teleop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudha/catkin_ws/src/navigation_experimental-hydro-devel/assisted_teleop/${idir}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${assisted_teleop_dep}_FOUND)
      find_package(${assisted_teleop_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${assisted_teleop_dep} REQUIRED ${depend_list})
  endif()
