...
if("TRUE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/sudha/catkin_ws/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/sudha/catkin_ws/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/sudha/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sudha <sudha@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudha/catkin_ws/src/robot_setup_tf/${idir}'.  Ask the maintainer 'sudha <sudha@todo.todo>' to fix it.")
    endif()
