...
PyTypeObject** Sbklibrviz_shibokenTypes;
// Current module's converter array.
SbkConverter** Sbklibrviz_shibokenTypeConverters;
// Global functions ------------------------------------------------------------

static PyMethodDef librviz_shiboken_methods[] = {
    {0} // Sentinel
};

// Classes initialization functions ------------------------------------------------------------
void init_rviz(PyObject* module);
void init_rviz_YamlConfigWriter(PyObject* module);
void init_rviz_YamlConfigReader(PyObject* module);
void init_rviz_OgreLogging(PyObject* module);
void init_rviz_VisualizationManager(PyObject* module);
void init_rviz_Config(PyObject* module);
void init_rviz_Config_MapIterator(PyObject* module);
void init_rviz_VisualizationFrame(PyObject* module);
void init_rviz_PanelDockWidget(PyObject* module);
void init_rviz_Property(PyObject* module);
void init_rviz_BoolProperty(PyObject* module);
void init_rviz_Display(PyObject* module);
void init_rviz_DisplayGroup(PyObject* module);
void init_rviz_ViewController(PyObject* module);
void init_rviz_ToolManager(PyObject* module);
void init_rviz_Tool(PyObject* module);
void init_rviz_ViewManager(PyObject* module);
...
static PyObject* _constQList_QObjectPTR_REF_CppToPython__constQList_QObjectPTR_REF(const void* cppIn) {
    ::QList<QObject * >& cppInRef = *((::QList<QObject * >*)cppIn);
                ...
                // TEMPLATE - cpplist_to_pylist_convertion - START
        ...
        return pyOut;
        // TEMPLATE - cpplist_to_pylist_convertion - END
...
static void _constQList_QObjectPTR_REF_PythonToCpp__constQList_QObjectPTR_REF(PyObject* pyIn, void* cppOut) {
    ::QList<QObject * >& cppOutRef = *((::QList<QObject * >*)cppOut);
                ...
                // TEMPLATE - pyseq_to_cpplist_convertion - START
    ...
    // TEMPLATE - pyseq_to_cpplist_convertion - END
...
static PyObject* _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_(const void* cppIn) {
    ::QMap<QString, QVariant >& cppInRef = *((::QMap<QString, QVariant >*)cppIn);
        ...
        return pyOut;
      // TEMPLATE - cppmap_to_pymap_convertion - END
...
static void _QMap_QString_QVariant__PythonToCpp__QMap_QString_QVariant_(PyObject* pyIn, void* cppOut) {
    ::QMap<QString, QVariant >& cppOutRef = *((::QMap<QString, QVariant >*)cppOut);
                ...
                // TEMPLATE - pydict_to_cppmap_convertion - START
    PyObject* key;
    PyObject* value;
    Py_ssize_t pos = 0;
    ...
    // TEMPLATE - pydict_to_cppmap_convertion - END
...
static struct PyModuleDef moduledef = {
    ...
    /* m_name     */ "librviz_shiboken",
    /* m_doc      */ 0,
    /* m_size     */ -1,
    /* m_methods  */ librviz_shiboken_methods,
    /* m_reload   */ 0,
    /* m_traverse */ 0,
    /* m_clear    */ 0,
    /* m_free     */ 0
...
#endif
SBK_MODULE_INIT_FUNCTION_BEGIN(librviz_shiboken)
    {
    ...
    static PyTypeObject* cppApi[SBK_librviz_shiboken_IDX_COUNT];
    Sbklibrviz_shibokenTypes = cppApi;

    // Create an array of primitive type converters for the current module.
    static SbkConverter* sbkConverters[SBK_librviz_shiboken_CONVERTERS_IDX_COUNT];
    Sbklibrviz_shibokenTypeConverters = sbkConverters;

#ifdef IS_PY3K
    PyObject* module = Shiboken::Module::create("librviz_shiboken", &moduledef);
#else
    PyObject* module = Shiboken::Module::create("librviz_shiboken", librviz_shiboken_methods);
#endif

    // Initialize classes in the type system
    init_rviz(module);
    init_rviz_YamlConfigWriter(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_YamlConfigReader(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_OgreLogging(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_VisualizationManager(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_Config(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_Config_MapIterator(Sbklibrviz_shibokenTypes[SBK_RVIZ_CONFIG_IDX]->tp_dict);
    init_rviz_VisualizationFrame(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_PanelDockWidget(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_Property(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_BoolProperty(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_Display(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_DisplayGroup(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_ViewController(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_ToolManager(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_Tool(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);
    init_rviz_ViewManager(Sbklibrviz_shibokenTypes[SBK_RVIZ_IDX]->tp_dict);

    // Register converter for type 'const QList<QObject*>&'.
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QOBJECTPTR_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _constQList_QObjectPTR_REF_CppToPython__constQList_QObjectPTR_REF);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QOBJECTPTR_IDX], "const QList<QObject*>&");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QOBJECTPTR_IDX],
    ...
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QBYTEARRAY_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QByteArray__CppToPython__QList_QByteArray_);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QBYTEARRAY_IDX], "QList<QByteArray>");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QBYTEARRAY_IDX],
    ...
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QACTIONPTR_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QActionPTR__CppToPython__QList_QActionPTR_);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QACTIONPTR_IDX], "QList<QAction*>");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QACTIONPTR_IDX],
    ...
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QDOCKWIDGETPTR_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QDockWidgetPTR__CppToPython__QList_QDockWidgetPTR_);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QDOCKWIDGETPTR_IDX], "QList<QDockWidget*>");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QDOCKWIDGETPTR_IDX],
    ...
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(Sbklibrviz_shibokenTypeConverters[SBK_LIBRVIZ_SHIBOKEN_QMAP_QSTRING_QVARIANT_IDX],
    ...
    Shiboken::Module::registerTypes(module, Sbklibrviz_shibokenTypes);
    Shiboken::Module::registerTypeConverters(module, Sbklibrviz_shibokenTypeConverters);

    if (PyErr_Occurred()) {
        PyErr_Print();
        Py_FatalError("can't initialize module librviz_shiboken");
    }
