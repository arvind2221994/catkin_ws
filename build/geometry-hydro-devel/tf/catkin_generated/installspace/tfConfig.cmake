...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kiran/catkin_ws/install/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@willowgarage.com>' to fix it.")
    endif()
