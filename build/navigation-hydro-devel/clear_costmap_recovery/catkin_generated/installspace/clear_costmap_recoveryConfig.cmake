...
if("FALSE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/kiran/catkin_ws/src/navigation-hydro-devel/clear_costmap_recovery)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kiran/catkin_ws/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()
