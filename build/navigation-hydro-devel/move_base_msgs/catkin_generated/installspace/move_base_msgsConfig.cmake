...
if("FALSE" STREQUAL "TRUE")
  set(move_base_msgs_SOURCE_PREFIX /home/sudha/catkin_ws/src/navigation-hydro-devel/move_base_msgs)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudha/catkin_ws/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()
