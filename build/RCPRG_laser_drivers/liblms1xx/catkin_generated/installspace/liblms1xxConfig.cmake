...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'liblms1xx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kiran/catkin_ws/install/${idir}'.  Ask the maintainer 'kp <kp@todo.todo>' to fix it.")
    endif()
