...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudha/catkin_ws/install/${idir}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
    endif()
